...
function HeaderAuthorized() {
  const locationNow = useLocation().pathname.slice(1);
        ...
        <div className="header__content">
          ...
          <nav className="navigation navigation_align_justify">
            <ul className="navigation_links">
              ...
              (locationNow === "movies" && "navigation__link_mode_active")}>
                <a href="/movies">Фильмы</a>
              </li>
              <li className={"navigation__link  navigation__link_theme_light " +
              (locationNow === "saved-movies" && "navigation__link_mode_active")}>
                <a href="/saved-movies">Сохраненные фильмы</a>
              </li>
            </ul>
            <a href="/profile" className="button button_account">
              Аккаунт
            </a>
              ...
              <div className="burger__menu-container">
                <ul id="burger__menu">
                  ...
                  <li>
                    <a
                      href="/profile"
                      className="button button_account button_account-mobile"
                    >
                      Аккаунт
                    </a>
                  </li>
